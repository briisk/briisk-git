...
## Main branches
  ...
  * **staging** - main branch for testing, you should merge every minor and major release (x.x.0) and hotfixes here, from there we should create patch releases (1.2.x), history shouldn't be modified
